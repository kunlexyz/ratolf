...
window.onload = function(){
    ...
    function slideMini(){
        ...
        if(window.innerWidth > 1550){slide_height=700}
        else if(window.innerWidth < 490){slide_height=150}
        else if(window.innerWidth < 951){slide_height=250}else{slide_height=500}
